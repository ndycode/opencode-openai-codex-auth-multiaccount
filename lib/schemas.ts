...
export const PluginConfigSchema = z.object({
	...
	hashlineBridgeHintsMode: z.enum(["off", "hints", "strict", "auto"]).optional(),
	toolArgumentRecoveryMode: z.enum(["off", "safe", "schema-safe"]).optional(),
	modelCapabilitySyncMode: z.enum(["off", "safe"]).optional(),
	modelCapabilityCacheTtlMs: z.number().min(1_000).optional(),
	retryPolicyMode: z.enum(["legacy", "route-matrix"]).optional(),
	rerouteNoticeMode: z.enum(["off", "log", "log+ui"]).optional(),
	jsonRepairMode: z.enum(["off", "safe"]).optional(),
	configDoctorMode: z.enum(["off", "warn"]).optional(),
	policyProfile: z.enum(["stable", "balanced", "aggressive"]).optional(),
	accountScopeMode: z.enum(["global", "project", "worktree"]).optional(),
	tokenRefreshSkewMode: z.enum(["static", "adaptive"]).optional(),
